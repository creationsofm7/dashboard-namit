...
class IMUSensorManager:
    ...
    async def connect_to_sensors(self, user_id, customer_id, exercise_id):
        ...
        if not devices:
            ...
            self.sensors = {
                "LL": {"id": "LL", "name": "Left Lower", "battery": 85, "connected": True, "file": exercise_dir / "LL.csv"},
                "LU": {"id": "LU", "name": "Left Upper", "battery": 92, "connected": True, "file": exercise_dir / "LU.csv"},
                "RL": {"id": "RL", "name": "Right Lower", "battery": 78, "connected": True, "file": exercise_dir / "RL.csv"},
